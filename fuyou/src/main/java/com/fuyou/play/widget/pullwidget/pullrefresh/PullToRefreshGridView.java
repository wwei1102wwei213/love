...
public class PullToRefreshGridView extends PullToRefreshBase<GridView> implements OnScrollListener {
    ...
    public void setHasMoreData(boolean hasMoreData) {
        if (this.mFooterLayout != null && !hasMoreData) {
            this.mFooterLayout.setState(State.NO_MORE_DATA);
        }
    }
    ...
    public void onPullUpRefreshComplete() {
        ...
        if (this.mFooterLayout != null) {
            this.mFooterLayout.setState(State.RESET);
        }
    }
    ...
    private boolean hasMoreData() {
        if (this.mFooterLayout == null || this.mFooterLayout.getState() != State.NO_MORE_DATA) {
            return true;
        }
        return false;
    }
