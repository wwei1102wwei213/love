...
public class RecyclerViewElasticityAdapter implements IElasticityAdapter {
    ...
    protected class ImplHorizLayout implements Impl {
        ...
        public boolean isInAbsoluteStart() {
            return !RecyclerViewElasticityAdapter.this.mRecyclerView.canScrollHorizontally(-1);
        }
    ...
    protected class ImplVerticalLayout implements Impl {
        ...
        public boolean isInAbsoluteStart() {
            return !RecyclerViewElasticityAdapter.this.mRecyclerView.canScrollVertically(-1);
        }
    ...
    public RecyclerViewElasticityAdapter(RecyclerView recyclerView, Callback itemTouchHelperCallback) {
        this(recyclerView);
        setUpTouchHelperCallback(itemTouchHelperCallback);
    }

    public RecyclerViewElasticityAdapter(RecyclerView recyclerView, Impl impl, Callback itemTouchHelperCallback) {
    ...
    protected void setUpTouchHelperCallback(Callback itemTouchHelperCallback) {
        new ItemTouchHelper(new ItemTouchHelperCallbackWrapper(itemTouchHelperCallback) {
            public void onSelectedChanged(ViewHolder viewHolder, int actionState) {
                RecyclerViewElasticityAdapter.this.mIsItemTouchInEffect = actionState != 0;
