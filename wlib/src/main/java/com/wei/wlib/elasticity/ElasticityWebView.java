...
public class ElasticityWebView extends WebView {
    ...
    public ElasticityWebView(Context context) {
        super(context);
    }

    public ElasticityWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ElasticityWebView(Context context, AttributeSet attrs, int defStyleAttr) {
