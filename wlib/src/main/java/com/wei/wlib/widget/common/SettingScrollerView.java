 ...
 */
public class SettingScrollerView extends LinearLayout {
    ...
    public SettingScrollerView(Context context) {
        this(context,null);
    }

    public SettingScrollerView(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public SettingScrollerView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.SettingScrollerView);
        visibilityHeight = ta.getDimension(R.styleable.SettingScrollerView_visibility_height,200);
        ta.recycle();
