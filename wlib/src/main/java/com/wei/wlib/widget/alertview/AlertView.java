...
public class AlertView {
    ...
    protected void initListView(){
        ...
        if(cancel != null && style == Style.Alert){
            View itemView = LayoutInflater.from(context).inflate(R.layout.wlib_alert_item_alertbutton, null);
            ...
            tvAlert.setBackgroundResource(R.drawable.wlib_alert_button_bottom);
    ...
    protected void initActionSheetViews(LayoutInflater layoutInflater) {
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.wlib_alert_layout_actionsheet,contentContainer);
    ...
    protected void initAlertViews(LayoutInflater layoutInflater) {
        ...
        ViewGroup viewGroup = (ViewGroup) layoutInflater.inflate(R.layout.wlib_alert_alertview, contentContainer);
        initHeaderView(viewGroup);
        ...
        if(mDatas.size()<=HORIZONTAL_BUTTONS_MAXCOUNT){
            ...
            for (int i = 0; i < mDatas.size(); i ++) {
                ...
                if(mDatas.size() == 1){
                    ...
                    tvAlert.setBackgroundResource(R.drawable.wlib_alert_button_left);
                }
                else if(i == mDatas.size() - 1){//设置最右边的按钮效果
                    tvAlert.setBackgroundResource(R.drawable.wlib_alert_button_right);
                }
