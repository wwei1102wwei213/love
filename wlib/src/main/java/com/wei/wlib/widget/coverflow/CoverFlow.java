package com.wei.wlib.widget.coverflow;


import android.support.v4.view.ViewPager;

import android.support.v4.view.LinkagePager;
import com.wei.wlib.widget.coverflow.core.CoverTransformer;
import com.wei.wlib.widget.coverflow.core.LinkageCoverTransformer;
...
public class CoverFlow {
 ...
 //   public static final float DEFAULT_SPACE_SIZE   = 0f;
    ...
    public CoverTransformer getCoverTransformer() {
        return coverTransformer;
    }
    ...
    public CoverFlow(CoverFlow.Builder builder){
        ...
        if(this.viewPager != null){
            coverTransformer = new CoverTransformer(this.scaleValue,this.pagerMargin,this.spaceSize,this.rotationY);
            this.viewPager.setPageTransformer(false,coverTransformer);
