package com.wei.wlib.widget.coverflow.core;
...
public class PagerContainer extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setPagerChangeListener(PagerChangeListener changeListener) {
        this.changeListener = changeListener;
    }


    public void setNeedsRedraw(boolean mNeedsRedraw) {
        this.mNeedsRedraw = mNeedsRedraw;
    }
    ...
    private void setViewPagerScrollSpeed( ){
        try {
            ...
            CustomScroller scroller = new CustomScroller(mPager.getContext(),
    ...
    public void onPageSelected(int position) {
        ...
        if (changeListener!=null) {
            changeListener.onPagerSelected(position);
        }
    }
