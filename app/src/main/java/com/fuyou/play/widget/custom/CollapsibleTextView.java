...
public class CollapsibleTextView extends LinearLayout implements View.OnClickListener {
    ...
    private void initView() {
        COLLAPSIBLE_STATE_SHRINKUP_TEXT = mContext.getResources().getString(R.string.collapse_text);
        COLLAPSIBLE_STATE_SPREAD_TEXT = mContext.getResources().getString(R.string.full_text);
