...
public class TestApi {
    ...
    public static int  year, month, day, hour, minute, day_light, timezone;
    public static double gmt, longitude, latitude;

    public static int julian;
    public static double t;

    public static double xa, ya, za, ab, zw, x1, z1, y_1, ss, p;
    public static double cusp1, cusp2, temp, k, span;

    public static double[] house = new double[12];
    public static int[] inhouse = new int[10];

    private static double[] pdata0 = {358.475800, 35999.049800,-0.000200, 0.016750, -0.000040, 0, 1, 101.220800, 1.719200, 0.000450, 0, 0, 0, 0, 0};
    private static double[] pdata1 = new double[15];
    private static double[] pdata2 = {102.279400, 149472.515000, 0, 0.205614, 0.000020, 0, 0.387100, 28.753800, 0.370300, 0.000100, 47.145900, 1.185200, 0.000200, 7.009000, 0.001860};
    private static double[] pdata3 = {212.603200, 58517.803900, 0.001300, 0.006820, 0.000050, 0, 0.723300, 54.384200, 0.508200, -0.001400, 75.779600, 0.899900, 0.000400, 3.393600, 0.001000};
    private static double[] pdata4 = {319.529400, 19139.858500, 0.000200, 0.093310, 0.000090, 0, 1.523700, 285.431800, 1.069800, 0.000100, 48.786400, 0.770990, 0, 1.850300, -0.000700};
    private static double[] pdata5 = {225.492800, 3033.687900, 0, 0.048380, -0.000020, 0,5.202900, 273.393000, 1.338300, 0, 99.419800, 1.058300, 0, 1.309700, -0.005200};
    private static double[] pdata6 = {174.215300, 1223.507960, 0, 0.054230, -0.000200, 0, 9.552500, 338.911700, -0.316700, 0, 112.826100, 0.825900, 0, 2.490800, -0.004700};
    private static double[] pdata7 = {74.175700, 427.274200, 0, 0.046820, 0.000420, 0, 19.221500, 95.686300, 2.050800, 0, 73.522200, 0.524200, 0, 0.772600, 0.000100};
    private static double[] pdata8 = {30.132940, 240.455160, 0, 0.009130, -0.001270, 0, 30.113750, 284.168300, -21.632900, 0, 130.684150, 1.100500, 0, 1.779400, -0.009800};
    private static double[] pdata9 = {229.947220, 144.913060, 0, 0.248640, 0, 0, 39.517740, 113.521390, 0, 0, 108.954440, 1.396010, 0.000310, 17.146780, 0};
    private static double[][] planetDatas = {pdata0,pdata1,pdata2,pdata3,pdata4,pdata5,pdata6,pdata7,pdata8,pdata9};
    private static double[] _planetDatas = new double[10];

    public static List<HORAspect> _aspects;
    ...
    public static void main(String[] args){
        ...
        HORChartResult result = calculateWithBornInfo();
    ...
    public static HORChartResult calculateWithBornInfo()
    {
    ...
    private static double polara (double x, double y)
    {
    ...
    public static double plac(double ff, double y, double r1, double ra, double ob, double la)
    {
        double x = -1;
        if (y == 1)
        {
    ...
    public static void calculateGMTandLocation()
    {
        ...
        gmt = hour + (float)minute / 60.f + timezone - day_light;
        if (gmt < 0)
        {
            gmt = gmt + 24;
            julian = julian - 1;
    ...
    public static void calculatePlanetLocations() {
        t = (julian - 2415020 + (gmt / 24.f - 0.500000)) / 36525;
        for (int i = 0; i<10; i++) {
            if (i == 1) {
                double da = t * 36525;
...
//            self.planetDatas[i] = @(c);
    ...
    public static void calculateAspects() {
    ...
    public static double degree(double l) {
        double h = rem(l, 30);
        return h;
    }

    public static List<HORHouseData> calculateHouseDatas()
    {
...
//            System.out.println("z:"+z);
    ...
    public static List<HORPlanetData> calculatePlanetDatas()
    {
    ...
    public static void calculateSynastryPlanetHouseDate(List<HORPlanetData> horPlanetDatas, List<HORHouseData> mainHouseDates) {
