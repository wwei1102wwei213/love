...
import com.fuyou.play.util.tarot.TarotCard;
...
public class TarotChooseFutureActivity extends BaseActivity {
...
//    protected EditText mQuestionEdit;
    ...
    private int[] mGroupIndexes = new int[] {
            TarotManager.TAROT_CARD_GROUP_INDEX_PAST,
            TarotManager.TAROT_CARD_GROUP_INDEX_CURRENT,
            TarotManager.TAROT_CARD_GROUP_INDEX_FUTURE,
    };
...
//        setStatusBarTranslucent();
        setFullScreen();
        setContentView(R.layout.activity_tarot_choose_future);
        initView();
    }
...
//        mQuestionEdit = (EditText) findViewById(R.id.question_edit);
        ...
        mReadingText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /*Intent intent = new Intent(TarotChooseFutureActivity.this, TarotThreeReadActivity.class);
        ...
        mStartLayout.findViewById(R.id.tarot_card_image).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(question)) {
                    new AlertDialog.Builder(TarotChooseFutureActivity.this)
                            .setTitle("Notice")
                            .setMessage("Please write down your question before play Tarot.")
    ...
    private void showCardContent(int index) {
        TarotCard card = TarotManager.getInstance().getTarotCard(mGroupIndexes[index], mCardIndexes[index]);
        int drawable = getResources().getIdentifier("tarot_card_" + (mCardIndexes[index] + 1), "mipmap", getPackageName());
        /*Intent intent = new Intent(TarotChooseFutureActivity.this, TarotSingleReadActivity.class);
        ...
        intent.putExtra(TarotSingleReadActivity.INTENT_CARD_DESCRIPTION, mCardReversed[index] ? card.getReversedContent() : card.getUprightContent());
        startActivity(intent);*/
    }
    ...
    private void showChooseAnimation() {
        if (mChoosedCardCount < mAnimationViews.length) {
            ...
            TranslateAnimation animation = new TranslateAnimation((width - animView.getWidth()) / 2 - locationInWindow[0], 0, height - locationInWindow[1] - animView.getHeight(), 0);
