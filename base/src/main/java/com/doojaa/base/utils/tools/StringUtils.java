...
import com.doojaa.base.BaseApplication;
...
public class StringUtils {
    ...
    public static String getString(Context context, @StringRes int id){
        if (context==null) return getString(id);
    ...
    public static String getString(Context context, @StringRes int id, Object... formatArgs){
        if (context==null) return getString(id, formatArgs);
        return context.getApplicationContext().getResources().getString(id,formatArgs);
    }
