...
public class Const {
    ...
    public static final String BASE_NAME = "fuyou";
    ...
    public final static String SL_DISK_IMG_BIG = Environment.getExternalStorageDirectory().getPath() + "/"+BASE_NAME+"/image/big/"; //大图片的本地存储*/
    public final static String SL_DISK_IMG_SMALL = Environment.getExternalStorageDirectory().getPath() + "/"+BASE_NAME+"/image/small/"; //小图片的本地存储*/
    public final static String SL_DISK_IMG_TEMP = Environment.getExternalStorageDirectory().getPath() + "/"+BASE_NAME+"/temp/";
